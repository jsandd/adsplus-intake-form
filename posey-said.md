...
- **[Confirmed]** Hunt Items (the treasure, the checkpoint and any placed clue) are NOT underwater, on private property, in caves, mines or tunnels, anywhere that needs rappelling, associated with man-made buildings, near graves or grave markers, or in dangerous places. *(treasure.quest rules, Mar 2025)*
- **[Confirmed]** All Hunt Items ARE more than one mile from anywhere Posey, his family or friends live, work or own property, including their businesses; on publicly accessible land anyone can visit; safe to get to. *(treasure.quest rules, Mar 2025)*
- **[Confirmed]** You do NOT need climbing gear or ropes, permission to enter private land, swimming skills, ladders or climbing skills, or a high-clearance vehicle. *(treasure.quest rules, Mar 2025)*
- **[Confirmed]** Railroad tracks: 'I consider them to be a man-made structure. Yes.' Then: 'Based on how the rules are described, railroad tracks are ruled out.' *(Dillon Q&A, Jun 21 2025; Seekers Summit, Mar 28 2026)*
...
- **[Confirmed]** Would a solver make more progress searching for hidden thematic or symbolic rules governing the poem, or by treating it more like Fenn's poem? 'Probably roughly both in equal measure.' *(Seekers Summit Q&A transcript, Mar 28 2026 (23:07))*
- **[Confirmed]** Numbers are indirectly associated with the poem, hidden in words and wordplay: yes. Homophones and wordplay for numbers: 'Yes', kept in play. Anagrams: 'I haven't specified.' *(Seekers Summit, Mar 28 2026)*
- **[Said]** There IS a distance element in following the clues. *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** Does timing matter, such as being at a spot at a specific time of day? 'That's an oddly specific question. What I will say is that the element of time, if it wasn't already obvious through the Netflix series, is important.' *(Seekers Summit Q&A transcript, Mar 28 2026 (2:34))*
- **[Confirmed]** Is there a time-travel element to the hunt? 'Not to my knowledge.' *(Seekers Summit Q&A transcript, Mar 28 2026 (1:08:05))*
- **[Confirmed]** Anything to clarify about the structure logic of the poem? 'There's nothing that I'm aware of that needs clarification right now.' *(Seekers Summit Q&A transcript, Mar 28 2026 (1:18:47))*
- **[Confirmed]** Is there a question he is shocked no one has asked? 'I can think of one very specific question that would be extremely useful to ask… I can't verbalize it though.' *(Seekers Summit Q&A transcript, Mar 28 2026 (1:19:07))*
- **[Confirmed]** Is the poem an instruction manual, a map, or both? 'In a way, a map can be an instruction manual, so I guess, yeah.' *(Sandal Sanders livestream, Sep 2025)*
- **[Said]** 'From beginning to end of the poem… it will inherently create some sort of shape.' *(Interview, 2025 (JIBLE index))*
- **[Confirmed]** Are transitions between clues movement across meaningful geographic separation, or conceptual steps within the same area? 'Each clue in the poem is not meant to convey great distance.' *(Seekers Summit Q&A transcript, Mar 28 2026 (19:14))*
- **[Leaned]** Asked whether the poem is linear, several points miles apart, or a hybrid, he declined, then offered: 'there are some great movies out there: Indiana Jones and National Treasure.' *(Posey Q&A, 2025)*
- **[Said]** Backtracking: 'If you knew the entirety of the solution, then the answer is no. But if you go through the natural progression, the answer is more like a yes.' *(X Q&A via Mysterious Writings, Sep 2025)*
- **[Confirmed]** There are multiple valid ways to solve it: 'in case certain aspects of the mechanics don't work… there are other ways to approach it so that you end up finding it either way.' 'There is an optimal solution and fallback paths… someone might not quite understand one clue, they could still limp along.' *(Sandal livestream, Sep 27 2025; Dillon, Jun 2025)*
- **[Confirmed]** How verifiable is a solve? Between Sudoku and 'jump in the lake': 'a reasonable person would say okay, seems reasonable.' *(Seekers Summit, Mar 28 2026)*
- **[Said]** Asked for the distance from the first actionable clue to the treasure: 'just by virtue of going through the process of formulating that question, you might find the answer.' *(X Q&A via Mysterious Writings, Sep 2025)*
- **[Said]** 'How far from the first clue to the last in miles' is impossible to answer given how the clues are structured. *(Posey Q&A (MW compilation))*
- **[Confirmed]** Are there multiple meanings to 'castle'? 'Only one correct interpretation.' *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** Is 'bride' the right word? 'No. I'm pretty pleased with that one.' *(Seekers Summit, Mar 28 2026)*
- **[Declined]** Whether 'cast your pole' refers to a fishing pole: not specified. *(Posey Q&A (MW compilation))*
- **[Declined]** Whether the poem references Native American legends, or contains golf references: not specified. *(Posey Q&A (MW compilation))*

## 3. Solving from home, boots on the ground, and distances

- **[Said]** A 'fair amount' can be solved from home. Boots on the ground are required for retrieval. *(Posey Q&A (MW compilation))*
- **[Confirmed]** At which stanza does boots on the ground become absolutely required, with no at-home research able to substitute? 'Stanza four.' *(Seekers Summit Q&A transcript, Mar 28 2026 (8:00))*
- **[Confirmed]** 'If you've solved the poem in its entirety, you'll end up at an exact location.' *(treasure.quest FAQ)*
- **[Said]** It is walking distance from 'waters' silent flight' through 'round the bend, past the Hole.' *(Posey Q&A (MW compilation))*
...
- **[Confirmed]** Will the finder have come to know the site's personal lore and secrets? 'I think so.' *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** Is there a significant clue visible standing 15 feet from the container? 'The most accurate answer is no.' *(Seekers Summit, Mar 28 2026)*
- **[Said]** 'I did not put it in very close proximity to any man-made trail… so it is a little ways off.' He did not want a random hiker to stumble on it. *(Dillon Q&A, Jun 21 2025)*
- **[Said]** The entire hunt is based on naturally occurring structures and landscapes. Depending which solution path you take, one clue has a man-made implication. 'One clue arguably has a man-made implication, but the whole hunt could be solved using only natural structures depending on interpretation.' *(Dillon Q&A, Jun 21 2025)*
- **[Confirmed]** Do you need to move a rock or anything else to see the container, and would a flashlight help during the day? 'Something will need to be manipulated in order to see the treasure.' Depending on conditions, a flashlight could be helpful. *(Seekers Summit Q&A transcript, Mar 28 2026 (18:03); Posey Q&A (MW compilation))*
- **[Confirmed]** Is it buried? 'If you know where to go, it wouldn't matter either way.' He will not say whether it is buried because AI could use it. *(treasure.quest FAQ; X Marks the Pod)*
- **[Leaned]** Digging: 'not something I'm willing to rule out.' Metal detector: 'probably not.' *(Seekers Summit, Mar 28 2026)*
- **[Declined]** Do you need to move any rocks? 'I am going to punt on that one.' *(Seekers Summit Q&A transcript, Mar 28 2026 (42:19))*
- **[Confirmed]** Do you need to get your feet wet to obtain the treasure? 'You don't have to.' *(Seekers Summit Q&A transcript, Mar 28 2026 (1:07:47))*
...
- **[Said]** The Hole carries no man-made implication: a direct 'no.' *(Seekers Summit, Mar 28 2026)*
- **[Declined]** Does the Hole correspond to a place with 'hole' in its name (Jackson Hole, Big Hole River)? 'An on the nose question.' Not answered. *(Seekers Summit, Mar 28 2026)*
- **[Declined]** Is 'double arcs on granite bold' the clue with the man-made implication? Punted. *(Dillon Q&A, Jun 21 2025)*
- **[Declined]** Do the arcs exist naturally or were they created? 'A strange question to answer since he knows what he knows.' Not answered. *(Dillon Q&A, Jun 21 2025)*
- **[Declined]** Is 'double arcs' a directional bearing? Punted. *(Seekers Summit, Mar 28 2026)*

## 6. Stanza 3: ursa, he, the bride, the gates, her face

- **[Confirmed]** Is 'east' a portion within one Ursa, or is there a west Ursa and an east Ursa? 'You only need to worry about Ursa East.' *(Seekers Summit, Mar 28 2026)*
...
- **[Said]** Does 'return her face' imply a physical rotation? 'The technically correct answer is yes.' *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** How far is 'her face' from 'the place'? 'Probably not as far as many people might think.' *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** How far is the treasure from the bride? 'A matter of perspective.' *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** Do you need to be at the bride to identify her foot of three? He stalled, re-read the line, then answered: No. *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** Are 'the place' (3:4) and 'the sacred space' (4:4) the same location? 'Not necessarily.' *(Seekers Summit, Mar 28 2026)*
- **[Declined]** Is the place in her face or her gaze? No clarity given. *(Seekers Summit, Mar 28 2026)*

## 7. The checkpoint

- **[Said]** There is a built-in checkpoint. It gives the reassuring feeling you are not lost and 'zero doubt' you are trending right. You are at least halfway through the poem's clues when you reach it. It is part of the poem, a stage of the journey. Excellent chance you find the treasure if you are first to it. *(Posey Q&A (MW compilation))*
...
- **[Leaned]** Do the states chosen for the Summit events have anything to do with where the treasure is? 'I'm certainly not going to rule them out.' *(Seekers Summit Q&A transcript, Mar 28 2026 (1:09:13))*
- **[Said]** 'The treasure is absolutely hidden somewhere on the map that I've published.' The map is useful, 'for a couple different reasons.' *(Posey Q&A; X Marks the Pod)*
- **[Said]** 'I chose the landmarks to be labeled, but the map was designed by a third party. Any incorrect names, positions, and elevations are not intentional.' *(Posey (quoted in research))*
- **[Said]** The website map's missing state capital and misspellings are accidental. *(Public statements (research report))*
- **[Said]** Is the site within 75 miles of somewhere he searched for the Fenn chest? 'I searched a lot of places, guys. Uh, so yeah, I mean it's true to say that at some point I had searched for the Fenn treasure within that 75 mile radius. Yeah.' He then walked it back, not wanting people to think he had eliminated states, and said his early idea of the Rocky Mountains was 'incredibly broad, any mountain with rocks.' *(Seekers Summit, Mar 28 2026)*
- **[Said]** During his Fenn search he believes he was extremely close to the chest in Yellowstone, possibly within 10 to 15 feet, and missed it. *(Public statements (research report))*
- **[Confirmed]** Seeing the animal while hiding gave him no fear: 'It was quite the opposite.' *(Seekers Summit Q&A transcript, Mar 28 2026 (38:34))*
- **[Confirmed]** An animal seen while hiding: mammalian, NOT a moose, the first time he had seen it in nature. 'If I said the animal it could have a pretty profound impact on the search area.' Separately he has said he has seen a wolverine in the wild. *(Seekers Summit, Mar 28 2026)*

## 9. The book, the map, the logo, the dedication

- **[Confirmed]** The Netflix hints 'guide you in the book.' *(Dillon Q&A, Jun 21 2025)*
- **[Confirmed]** 'It is true to say that layer five has some bearing on the treasure hunt.' Not defined further. *(Seekers Summit, Mar 28 2026)*
- **[Confirmed]** The ankh in the legal section is not a clue. 'The Legal Lowdown' has no hints. *(Seekers Summit, Mar 28 2026)*
...
- **[Confirmed]** Discrepancies between the hardcover and the audiobook or ebook (Big Hill, Doc's death, mileage, age) are not intentional. 'I did publish an errata on treasure.quest. The purpose is to make sure people don't spend time on things that don't matter that were truly just mistakes.' *(Seekers Summit Q&A transcript, Mar 28 2026 (46:35))*
- **[Confirmed]** Is the number 42 relevant to finding the treasure? 'I guess the short answer is yes.' On 42: 'The Hitchhiker's Guide to the Galaxy is a fantastic book.' Asked about the 42 on his taillight, he gave no more. *(Seekers Summit, Mar 28 2026; X Marks the Pod)*
...
- **[Said]** He had no creative control and did not know scene order, framing or focus. He hid hints during filming that even the producers did not know about. Clues exist only 'where I had some notion of control, directly or indirectly.' *(Posey Q&A; Dillon Q&A)*
- **[Confirmed]** At least five singular clues, plus compound clues that need several scenes. *(Dillon Q&A, Jun 21 2025)*
- **[Confirmed]** Two 'super obvious' hints: 'It's either episode two or three. It is a scene that does not have me in it. But it was a scene that I had some control over. If you rewatch it, it'll be pretty obvious.' By Sep 27 2025 he said people had figured these out. *(Dillon Q&A, Jun 21 2025; Sandal livestream)*
- **[Confirmed]** The lawyer / Carl scene: zero clues. *(Dillon Q&A, Jun 21 2025)*
...
- **[Confirmed]** Questions he would ask a seeker: 'Understanding the creator and their intent is important. It's not really a question you should ask, but a theme.' *(Seekers Summit Q&A transcript, Mar 28 2026 (1:21:14))*
- **[Said]** The hunt is dedicated to four departed loved ones: his father, his grandfather, his brother Brandon, and his dog Tucker. Tucker was a Vizsla, a Hungarian breed (which is what MAGYAR nods to). *(Book dedication; Posey, April 2026)*
